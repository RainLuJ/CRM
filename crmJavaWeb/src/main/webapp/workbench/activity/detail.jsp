	...
	function showRemarkList() {
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data,function (i,n) {
					...
					/*
						javascript:void(0);
							...
							即：void(0)用于执行某些处理，但是不整体刷新页面的情况下
					...
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                                      ...
                                      /* 在遍历（动态拼接）当中直接触发事件（onclick）是最方便的 */
				...
				// 在选定标签之后追加元素  （但是会导致分割线被挤到下方，所以用上面的方法）
            ...
            $.ajax({
                ...
                success : function (data) {
                    ...
                    if(data.success){
                        ...
                        //删除备注成功
                        //这种做法不行，记录使用的是before方法，每一次删除之后，页面上都会保留原有的数据，并追加第二次查询到的数据
                        //showRemarkList();
